...
- follow boot - root - home - swap - efi scheme (in the tutorial above its home - root, but whatever, you can choose install beside win11, and don't even have create a separate home if don't want to install additional linux OSs)
